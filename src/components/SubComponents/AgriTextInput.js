...
export default class AgriTextInput extends Component {
  render() {
    ...
    let {keyboardType, placeholder, value, onChangeText} = this.props;
    ...
    return (
      <View style={[{flexDirection: 'row', borderColor: color, borderWidth: 1, borderRadius: height / 2 - 8, alignItems: 'center'}, this.props.style]}>
        ...
        <TextInput style={{flex: 1, paddingLeft: 10, paddingRight: 10, fontSize: 14}}  autoCorrect={false} placeholderTextColor={'rgba(200, 200, 200, 1)'} keyboardType={keyboardType} placeholder={placeholder} value={value} onChangeText={onChangeText.bind(this)}/>
      </View>
    )
  }
}